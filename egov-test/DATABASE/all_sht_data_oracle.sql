...
-- 게시판마스터
insert into TEST_TABLE(TEST_ID,TEST_NAME,TEST_AGE,TEST_JOB) values ('1','aa',30,'개발자');
insert into TEST_TABLE(TEST_ID,TEST_NAME,TEST_AGE,TEST_JOB) values ('2','bb',40,'개발자');
insert into TEST_TABLE(TEST_ID,TEST_NAME,TEST_AGE,TEST_JOB) values ('3','cc',50,'개발자');
insert into TEST_TABLE(TEST_ID,TEST_NAME,TEST_AGE,TEST_JOB) values ('4','aa',30,'개발자');
insert into TEST_TABLE(TEST_ID,TEST_NAME,TEST_AGE,TEST_JOB) values ('5','bb',40,'개발자');
insert into TEST_TABLE(TEST_ID,TEST_NAME,TEST_AGE,TEST_JOB) values ('6','cc',50,'개발자');
insert into TEST_TABLE(TEST_ID,TEST_NAME,TEST_AGE,TEST_JOB) values ('7','aa',30,'개발자');
insert into TEST_TABLE(TEST_ID,TEST_NAME,TEST_AGE,TEST_JOB) values ('8','bb',40,'개발자');
insert into TEST_TABLE(TEST_ID,TEST_NAME,TEST_AGE,TEST_JOB) values ('9','cc',50,'개발자');
